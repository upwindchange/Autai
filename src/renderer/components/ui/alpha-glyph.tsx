...
/**
 * The Greek α glyph (Material Symbols "alpha") used as the app-wide marker
 * for alpha-stage features. Rendered as a superscript icon: wrap the label
 * text in a `relative` span and place this inside, absolutely positioned at
 * the span's top-right.
 *
 * Color is state-driven at the callsite — e.g. Browser Use passes mode
 * colors; a neutral marker can leave `className` off for the inherited
 * currentColor.
 */
export const AlphaGlyph: FC<{ className?: string }> = ({ className }) => (
  <svg
