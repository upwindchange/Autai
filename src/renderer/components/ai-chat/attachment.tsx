  ...
  return (
    <AttachmentPrimitive.Root className="aui-attachment-root relative">
      ...
      >
        ...
        <div className="flex shrink-0 items-center justify-center bg-muted px-2.5 py-2">
          <FileIconDisplay
...
const AttachmentRemove: FC = () => {
  return (
    <AttachmentPrimitive.Remove asChild>
      <TooltipIconButton
        tooltip="Remove file"
        className="aui-attachment-tile-remove absolute end-1.5 top-1.5 size-3.5 rounded-full bg-popover text-muted-foreground opacity-100 shadow-sm hover:bg-popover/80 [&_svg]:text-foreground hover:[&_svg]:text-destructive"
        side="top"
      >
