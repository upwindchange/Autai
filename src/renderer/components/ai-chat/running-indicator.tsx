 ...
 *
 * The loader SVG below is inline and self-animating via SMIL, so no CSS
 * animate-spin is needed. Keep the wrapper span + role/aria so the flex gap
 * and a11y keep working.
 */
export const RunningIndicator: FC<{ className?: string }> = ({ className }) => (
  <span
    ...
    className={cn(
      "aui-running-indicator inline-flex items-center text-muted-foreground",
      className,
    )}
  >
    <svg
