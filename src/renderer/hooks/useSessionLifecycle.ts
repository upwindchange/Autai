 ...
 * Derives the active session from showSettings and mainTabId, and calls
 * POST /sessions/activate to ensure the session exists and is made active.
 */
export function useSessionLifecycle() {
  ...
  useEffect(() => {
    if (activeSessionId) {
      ...
      void httpClient.postCommand("/sessions/activate", {
