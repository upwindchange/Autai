...
export type ToolParams = { name: "calculate"; params: CalculateToolParams };

export type ToolResults = { name: "calculate"; result: CalculateToolResult };
...
function recursiveRepairData(data: any, schema: z.ZodTypeAny): any {
  ...
  if (schema instanceof z.ZodObject) {
    ...
    // Use the correct Zod API to get the shape
